const langArr = {
  title: {
    ru: 'Скоков Дмитрий, визитная карточка.',
    en: 'Skokov Dmitry CV',
  },
  ...
  age: {
    ru: '25 лет, Екатеринбург',
    en: '25 years old, Yekaterinburg',
  },
  ...
  'skills-text': {
    ru: 'Я работаю в программах ниже',
  ...
  'contacts-p1': {
    ru: 'Хочешь узнать побольше или просто поболтать?',
